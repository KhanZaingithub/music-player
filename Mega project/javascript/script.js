...
const playmusic = (track,pause=false)=>{
    ...
    document.querySelector(".duration").innerHTML = `${secondsToMinutesAndSeconds(currentSong.currentTime)}/8:35`;
}
...
async function main(){
    ...
    currentSong.addEventListener("timeupdate",()=>{
        document.querySelector(".duration").innerHTML = `${secondsToMinutesAndSeconds(currentSong.currentTime)}/
